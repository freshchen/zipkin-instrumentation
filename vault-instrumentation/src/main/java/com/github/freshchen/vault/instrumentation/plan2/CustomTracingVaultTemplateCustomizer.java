 ...
 * @since 2022/03/13
 **/
public class CustomTracingVaultTemplateCustomizer implements RestTemplateCustomizer {

    private final BeanFactory beanFactory;

    public CustomTracingVaultTemplateCustomizer(BeanFactory beanFactory) {
